...
/*
    ...
    void setUp() {
        ...
        user1 = new User(1l, "Abdullah", "Mamun", "17-NOV-1992",
                "auvyauvy@gmail.com", "01751015599", Gender.MALE, "1200", "Dhaka","Bangladesh", "Gopibag, Motijheel", "", "password",
                Role.USER,
                null);
        user2 = new User(1l, "Tanzima", "Azad", "01-JAN-1988",
                "tanzima@gmail.com", "01751015588", Gender.FEMALE, "9502", "Sydne", "Australia", "Sydne, Australia","", "password",
                Role.USER,
                null);
